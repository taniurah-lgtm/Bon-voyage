...
${renkyu}
  ...
  <div class="card"><ul>
    <li>マップは公開ページで見られます → <a href="/map.html">みんなのおでかけマップ</a></li>
    <li>公開ページは各スポット2件までですが、<b>サポーターの方は全件と写真つきの投稿</b>をご覧いただけます（このページに順次載せていきます）。</li>
    <li>投稿はどなたでもできます。<b>サポーターの方は長めの文章と写真もOK</b>です（フォームに合言葉を入れてください）。</li>
  </ul></div>
